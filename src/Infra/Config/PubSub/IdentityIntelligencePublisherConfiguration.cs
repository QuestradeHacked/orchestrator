...
public class IdentityIntelligencePublisherConfiguration : BasePublisherConfiguration<IdentityIntelligencePublisherMessage>
{
    public override Task HandleMessageLogAsync(ILogger logger, LogLevel logLevel, IdentityIntelligencePublisherMessage message, string logMessage, CancellationToken cancellationToken = default)
    {
