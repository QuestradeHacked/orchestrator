...
{
    public override Task HandleMessageLogAsync(ILogger logger, LogLevel logLevel, EmailIntelligencePublisherMessage message, string logMessage, CancellationToken cancellationToken = default)
    {
